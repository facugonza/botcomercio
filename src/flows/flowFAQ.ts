...
.addAnswer(
  "📊 *PLANES DE VENTA*\n\n" +
    ...
    "⚠️ *Importante:* Todo lo que el cliente pacte en 1 cuota en Plan D puede financiarlo en 1, 2 o 3 cuotas sin interés o en 6, 9 o 12 cuotas fijas en pesos.",
  { delay: 2000 }
)
.addAnswer(
...
.addAnswer(
  "✅ *RECOMENDACIONES*\n\n" +
    ...
    "– 🖥️ Solicitar POS a su asesor de la zona.\n" +
...
.addAnswer(
  "❌ *MOTIVOS DE RECHAZO DE CUPONES*\n\n" +
    "⚠️ *Motivos comunes de rechazo de cupones:*\n\n" +
    "– ✍️ Cupón ilegible o sin firma.\n" +
...
.addAnswer(
  "🌐 *VENTAS ONLINE*\n\n" +
    "Tarjeta Data ha implementado un servicio para ventas online. 🖥️ El proceso es automático y se valida instantáneamente.\n\n" +
    "✍️ Solo debes hacer firmar el cupón generado y guardarlo para posibles reclamos.\n" +
    "💵 La operación se liquida automáticamente en la próxima liquidación."
);
